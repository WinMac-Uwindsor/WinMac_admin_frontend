...
// import makeStyles from '@mui/styles/makeStyles';
  ...
  const Attendance = () => {
    ...
    function getAttendance(intake) {
      ...
      return fetch(
        "http://localhost:5000/winmac/studentData/attendance",
        {
          method: "POST",
    ...
    return (
        <div>
        <div className="button-container"><Button variant="contained" onClick={handleAttendanceFall}>Fall</Button>
        <Button variant="contained" onClick={handleAttendanceSpring}>Spring</Button>
        <Button variant="contained" onClick={handleAttendanceWinter}>Winter</Button>
        </div>
